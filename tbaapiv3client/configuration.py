...
class Configuration(object):
    ...
    def __init__(self, host="https://www.thebluealliance.com/api/v3",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("tbaapiv3client")
            ...
            'apiKey':
                {
                    ...
                    'in': 'header',
                    'key': 'X-TBA-Auth-Key',
                    'value': self.get_api_key_with_prefix('X-TBA-Auth-Key')
                },
        }
