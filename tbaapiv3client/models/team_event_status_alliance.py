...
class TeamEventStatusAlliance(object):
    ...
    def __init__(self, name=None, number=None, backup=None, pick=None, local_vars_configuration=None):  # noqa: E501
    ...
    def pick(self, pick):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and pick is None:  # noqa: E501
